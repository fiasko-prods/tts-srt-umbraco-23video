...
(function() {
    ...
    function checkVoiceWarning() {
        ...
        // Log all voices so we can see what Chrome has available
        console.log('🎤 voices:' + availableVoices.length + ' seeking lang:' + CFG.lang + '/' + CFG.langAlt);
        availableVoices.forEach((v, i) => console.log('  ' + i + ': ' + v.name + ' [' + v.lang + ']'));
        console.log('🎤 match: ' + (voice ? voice.name + ' [' + voice.lang + ']' : 'NONE'));
        ...
        // (Chrome may use online TTS even if voice doesn't appear in getVoices())
